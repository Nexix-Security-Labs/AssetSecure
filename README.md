![assetsecure-by-nsl](https://github.com/snipe/snipe-it/assets/197404/b515673b-c7c8-4d9a-80f5-9fa58829a602)
...
AssetSecure is actively developed and we [release quite frequently](https://github.com/snipe/snipe-it/releases). ([Check out the live demo here](https://snipeitapp.com/demo/).)
...
-----
### User's Manual
For help using AssetSecure, check out the [user's manual](https://snipe-it.readme.io/docs/overview).
...
Please see the [upgrading documentation]() for instructions on upgrading AssetSecure.
...
Please see the documentation on [contributing and developing for AssetSecure](https://snipe-it.readme.io/docs/contributing-overview).
...
To report a security vulnerability, please email security@nexixsecuritylabs.com instead of using the issue tracker.
